...
public class DepartmentController {
    ...
    public String removeAccountsInDepartment(@PathVariable(name = "accountIds")
                                             List<@AccountIdExists Integer> accountIds) {
    ...
    @PostMapping
    public String createDepartment(@RequestBody
                                   @Valid
                                   CreatingDepartmentForm form) {
        departmentService.createDepartment(form);
        return "create successfully!";
    }

    @PutMapping("/{id}")
    public String updateDepartment(@PathVariable(name = "id")
                                   @DepartmentIdExists
                                   Integer departmentId,
                                   @RequestBody
                                   @Valid
                                   UpdatingDepartmentForm form) {

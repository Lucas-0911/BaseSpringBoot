...
public class AuthController {
    ...
    @PostMapping("/login")
    public LoginInfoDTO login(@RequestBody
                              @Valid
                              LoginForm loginForm) throws AccountBlockException {
    ...
    public TokenDTO refreshtoken(@RefreshTokenValid
                                 String refreshToken) {
    ...
    public String resendAccountRegistrationTokenViaEmail(@RequestParam
    ...
    public String activeAccountViaEmail(@RequestParam
    ...
    public String sendAccountForgotPasswordTokenViaEmail(@RequestParam
                                                         @AccountUsernameOrEmailExists
    ...
    public String resetPasswordViaEmail(@Valid
                                        @RequestBody
    ...
    public String getUsernameFromForgotPasswordToken(@ForgotPasswordTokenValid
                                                     @NotBlank
